...
Looking at the coefficient, all the variables from the third model have meaningful p-value. Also there is an important drop in the sum of squared residuals (RSS). Also the variance of the residual dropped from `r round(summary(fit)$sigma,2)` in the initial model to `r round(summary(fit3)$sigma,2)` in the model 3.
